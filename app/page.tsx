...
// CTA on the site.
//
// The QR no longer encodes a store URL at all. It points at /download on our
// own domain, so it never needs regenerating when a listing changes and one
// code serves iPhone and Android. Regenerate only if the domain moves:
// `npm run qr`.
              ...
              <div className="relative grid md:grid-cols-[1fr_auto] gap-10 items-center">
                ...
                <div className="text-center md:text-left">
                  ...
                  {/* Two apps, two sets of buttons. This block used to offer a
                      ...
                      owner and a rider tapped the same button expecting
                      different products. */}
